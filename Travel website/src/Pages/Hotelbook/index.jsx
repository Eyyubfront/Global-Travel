...
const Hotelbook=()=>{
 ...
 <Box className="retrunsboxs" width="80%" marginTop="20px" height="194px" padding="40px" borderRadius="12px" sx={{boxShadow:"0px 4px 16px 0px rgba(17, 34, 17, 0.05)"}}>
 ...
 <Box padding="5px" width="100%" border="1px solid #8DD3BB">
 <Stack alignItems="center" gap="10px" flexDirection="row">
 
 <img style={{width:"100px"}} src={cvpark} alt="" />
 <Stack flexDirection="column">
 <Typography>
 CVK Park Bosphorus Hotel Istanbul
 </Typography>
