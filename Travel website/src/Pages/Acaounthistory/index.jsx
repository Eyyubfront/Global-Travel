...
<Typography className="boking" variant="h4">
Tickets/Bookings
</Typography>

<Box className="ticktetbox" borderRadius="12px" sx={{boxShadow:"0px 4px 16px 0px rgba(17, 34, 17, 0.05)",width:"100%",padding:"10px"}}>
...
Flights
        ...
        <Box width="300px" border="1px solid #8DD3BB">
...
<Link style={{textDecoration:"none",color:"black"}} to="/acaountstays">
...
>
    <Stack className="ticketboxesd"  flexDirection="row" alignItems="center" justifyContent="space-between">
        <Box padding="5px" width="80px" borderRadius="10%" border='1px solid #8DD3BB'>
            <img style={{width:"70px"}} src={emirates} alt="" />
        </Box>
        <Stack flexDirection="row" gap="10px">
